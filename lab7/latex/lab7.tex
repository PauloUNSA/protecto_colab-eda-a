...
\begin{document}
	...
	\begin{longtable}{|p{15cm}|}
		...
		\lstinputlisting[language=Java, caption={loadFile.java},numbers=left,]{src/loadFile.java}\\
		...
		\lstinputlisting[language=Java, caption={detectPlagiarism.java},numbers=left,]{src/detectPlagiarism.java}\\
