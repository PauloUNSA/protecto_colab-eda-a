	...
	\begin{table}
		...
		\resizebox{15cm}{!} {
			\begin{tabular}{|c|c|c|c|c|c|c|c|c|l|}
				...
				\multicolumn{9}{c}{\cellcolor[HTML]{FF0000}{\color[HTML]{FFFFFF} INFORMACIÓN BÁSICA}} \\ \hline
				\multicolumn{1}{|c|}{Asignatura} & \multicolumn{8}{|c|}{Estructura de datos y algoritmos} \\ \hline
				\multicolumn{1}{|c|}{Título de trabajo} & \multicolumn{8}{|c|}{Sort y Listas Enlazadas} \\ \hline
				
				\multicolumn{1}{|c|}{Numero de trabajo} & \multicolumn{2}{|c|}{04}&
				\multicolumn{1}{|c|}{Año Lectivo}&
				\multicolumn{2}{|c|}{2023-A}&
				\multicolumn{1}{|c|}{Nro. Semestre}&
				\multicolumn{2}{|c|}{III} \\ \hline
				
				\multicolumn{1}{|c|}{Fecha de presentación} & \multicolumn{2}{|c|}{11/06/2023} &
				\multicolumn{1}{|c|}{Hora de presentacion}&
				\multicolumn{5}{|c|}{11:59pm}\\ \hline
				
				
				\multicolumn{6}{|l|}{\parbox[t]{8cm}{Integrantes\\ 
						Hidalgo Chinchay, Paulo Andre\\ Betanzos Rosas, Taylor Anthony\\ Villafuerte Ccapira, Frank Alexis}} & \multicolumn{1}{|c|}{Nota (0-20)} &
				\multicolumn{2}{|c|}{xd}\\ \hline
				
				\multicolumn{9}{|l|}{DOCENTE(S): Edith Giovanna Cano Mamani} \\ \hline
