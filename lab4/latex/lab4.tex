...
\begin{document}
	...
	\begin{longtable}{|p{15cm}|}
			...
			Asismimo se agrego el metodo isEmpty para saber si estaba vacia y se sobreescribio
			el metodo toString para mostrar retornar la data del 1er al ultimo dato.}  \\
			\includegraphics[width=0.4\textwidth,keepaspectratio]{img/addInicio.png}\\
			\includegraphics[width=0.4\textwidth,keepaspectratio]{img/addFinal.png}\\
			\includegraphics[width=0.4\textwidth,keepaspectratio]{img/otros.png}\\
			\includegraphics[width=0.4\textwidth,keepaspectratio]{img/addInicio.png}\\
			\includegraphics[width=0.4\textwidth,keepaspectratio]{img/addFinal.png}\\
			\includegraphics[width=0.4\textwidth,keepaspectratio]{img/otros.png}\\
			\hline
